<?php
    ...
    if(isset($_POST)){
        ...
        $sql3="UPDATE user SET user_usn='$user_usn',user_firstname='$user_firstname',user_lastname='$user_lastname',user_profession='$user_profession',user_address='$user_address',user_email='$user_email',user_phone='$user_phone',user_password='$user_password',user_shortbio='$user_shortbio',user_dob='$user_dob',user_gender='$user_gender',user_website='$user_website' WHERE user_username = '$temp'";
